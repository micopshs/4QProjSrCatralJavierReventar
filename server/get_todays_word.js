...
const get_todays_word = function () {
    // get the full array
    const array_of_words = readFileSync(dirname(fileURLToPath(import.meta.url)) + "/list_of_5_letter_words.txt", "utf8").split("\n");
    ...
    const todays_random_number = Math.ceil(mulberry32(xmur3(today_string)())() * array_of_words.length);
    // return today's word
    const todays_word = array_of_words[todays_random_number];
    return todays_word;
};
export default get_todays_word;
//# sourceMappingURL=get_todays_word.js.map